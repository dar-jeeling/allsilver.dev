...
- `JavaScript`의 기본적인 컨셉들에 대해서 배울 수 있었습니다.
- `JavaScript`에서 제공하는 다양한 객체와 객체의 메서드들을 실습하여 숙달할 수 있었습니다.
- 처음으로 리드한 스터디였기 때문에, 다양한 방법(내용 발표, 뽀모도로를 이용한 독서, 퀴즈 작성)을 적용하여 **효과적인 기술 도서 스터디**에 대한 고민할 수 있는 기회가 되었습니다.
